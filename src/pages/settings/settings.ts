  ...
  return section(
    ...
    h('div', { class: 'row stack', 'data-search': 'webrtc ip indirizzo vpn videochiamate' },
      h('div', { class: 'text' },
        ...
        h('div', { class: 'desc' }, 'Le videochiamate nel browser (WebRTC) possono rivelare ai siti il tuo indirizzo IP, anche quello reale quando usi una VPN. Le chiamate di kMeet funzionano sempre.')),
