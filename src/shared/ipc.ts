...
export const IPC = {
  ...
  extClick: 'ext:click',
  extMenu: 'ext:menu',
  extPuzzle: 'ext:puzzle',
  extInstallStore: 'ext:install-store',
  evExtButtons: 'ext:buttons',
  evExtOffer: 'ext:offer',
...
export const INTERNAL = {
  ...
  syncStatus: 'internal:sync:status',
  syncProbe: 'internal:sync:probe',
  syncEnable: 'internal:sync:enable',
  syncUnlock: 'internal:sync:unlock',
  syncNow: 'internal:sync:now',
  syncDisable: 'internal:sync:disable',
  syncReset: 'internal:sync:reset',
  syncOptions: 'internal:sync:options',
  ...
  evAi: 'internal:ev:ai',
  evSync: 'internal:ev:sync',
  extList: 'internal:ext:list',
  extSetEnabled: 'internal:ext:set-enabled',
  extSetPinned: 'internal:ext:set-pinned',
  extRemove: 'internal:ext:remove',
  extInstallStore: 'internal:ext:install-store',
  extInstallFile: 'internal:ext:install-file',
  extLoadUnpacked: 'internal:ext:load-unpacked',
  extReload: 'internal:ext:reload',
  extOptions: 'internal:ext:options',
  extCheckUpdates: 'internal:ext:check-updates',
  extApplyUpdate: 'internal:ext:apply-update',
  extSetDevMode: 'internal:ext:set-dev-mode',
  evExtensions: 'internal:ev:extensions',
} as const;
