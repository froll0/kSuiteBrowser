...
export function sanitizeSettings(raw: unknown): Settings {
  ...
  return {
    ...
    extensionsButtonAdded: bool(s.extensionsButtonAdded, d.extensionsButtonAdded),
    extensionsDeveloperMode: bool(s.extensionsDeveloperMode, d.extensionsDeveloperMode),
